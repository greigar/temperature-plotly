...
The plot below shows land temperature from 1760 to 2013 (where available) for Berlin, Paris and Sydney.  A loess smoothing line is fitted through the markers for each city.
